...
Object.assign(PFP_KEY_TO_RATE_TYPE_MAP, {
  ...
  conventional_5_1_arm: "RATE_5_1_ARM",
...
export const RATE_TYPE_TO_PFP_KEY: Readonly<Partial<Record<RateType, string>>> = Object.freeze({
  ...
  RATE_5_1_ARM: "conventional_5_1_arm",
...
export const PROPERTY_TYPE_LABELS: Readonly<Record<PropertyType, string>> = Object.freeze({
...
const PROPERTY_TYPE_SET: ReadonlySet<PropertyType> = new Set(PROPERTY_TYPES);

export function isPropertyType(value: unknown): value is PropertyType {
  return typeof value === "string" && PROPERTY_TYPE_SET.has(value as PropertyType);
}

// ============================================================================
// Rate-type categories (v0.6.0 — grouping for tabbed UI surfaces)
// ============================================================================

export type RateTypeCategory =
  | "conventional"
  | "government"
  | "jumbo"
  | "non_qm"
...
export const RATE_TYPE_CATEGORY: Readonly<Record<RateType, RateTypeCategory>> = Object.freeze({
...
export const RATE_TYPE_CATEGORY_LABELS: Readonly<Record<RateTypeCategory, string>> = Object.freeze({
...
export const RATE_TYPE_CATEGORY_ORDER: readonly RateTypeCategory[] = [
  "conventional",
  "government",
  "jumbo",
  "non_qm",
